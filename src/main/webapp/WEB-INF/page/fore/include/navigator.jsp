    ...
    <div class="nav_main">
        ...
        <ul class="quick_li">
            <li class="quick_li_MyTaobao">
                <div class="sn_menu">
                    <a href="${pageContext.request.contextPath}/userDetails">我的舒适区<b></b></a>
                    <div class="quick_menu">
                        <a href="${pageContext.request.contextPath}/order/0/10">已买到的物品</a>
            ...
            <li class="quick_home"><a href="${pageContext.request.contextPath}">舒适购</a></li>
