...
<div class="banner_footer">
    ...
    <div  class="tmall-desc">
        <dl>
            ...
            <dd><a href="${pageContext.request.contextPath}/register" target="_blank">免费注册</a> <a
...
<%--                    width="105" height="105" alt="手机舒适购"></a>--%>
<%--            </dd>--%>
<%--        </dl>--%>
    </div>
</div>