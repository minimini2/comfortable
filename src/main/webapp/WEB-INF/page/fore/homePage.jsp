...
<head>
    ...
    <title>舒适购comfortable--欢迎来到舒适购</title>
</head>
<body>
<nav>
        ...
        <div class="mallSearch">
            <form action="${pageContext.request.contextPath}/product" method="get">
                <div class="mallSearch-input">
                    <input class="header_search_input" type="text" name="product_name" placeholder="请输入搜索内容"
                           maxlength="50">
...
<%--        <a href="http://vip.tmall.com/" target="_blank">舒适购会员</a>--%>
